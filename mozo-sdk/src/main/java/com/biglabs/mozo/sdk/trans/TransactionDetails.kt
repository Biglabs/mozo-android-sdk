    ...
    private fun bindData(history: Models.TransactionHistory) {
        ...
        if (sentType) {
            ...
            launch {
                ...
                launch(UI) {
                    text_detail_balance_value.text = balance.displayString()
                    text_detail_balance_rate_side.text = String.format(Locale.US, "(₩%s)", balance.multiply(currencyRate).displayString())
                }
            }
        } else {
        ...
        text_detail_amount_rate_side.text = String.format(Locale.US, "(₩%s)", history.amountInDecimal().multiply(currencyRate).displayString())
    }
