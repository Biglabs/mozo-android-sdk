...
class ContactRecyclerAdapter(private val contacts: List<Models.Contact>, private val itemClick: ((contact: Models.Contact) -> Unit)? = null) : RecyclerView.Adapter<ContactRecyclerAdapter.ItemViewHolder>(), SectionIndexer {
