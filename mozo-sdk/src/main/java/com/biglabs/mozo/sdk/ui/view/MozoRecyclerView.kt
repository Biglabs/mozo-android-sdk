...
internal class MozoRecyclerView : RecyclerView {
    ...
    private var sectionDecoration: ContactSectionDecoration? = null
    ...
    constructor(context: Context?, attrs: AttributeSet?, defStyle: Int) : super(context, attrs, defStyle) {
        ...
        context?.run {
            ...
            val typedArray = obtainStyledAttributes(attrs, R.styleable.MozoRecyclerView, 0, defStyle)
            try {
    ...
    override fun onTouchEvent(e: MotionEvent?): Boolean {
        e?.run {
            if (x >= width - letterBarWidth && sectionDecoration != null) {
