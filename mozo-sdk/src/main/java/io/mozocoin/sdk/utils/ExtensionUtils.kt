...
fun EditText.onAmountInputChanged(
    ...
    filters =
        arrayOf<InputFilter>(DecimalDigitsInputFilter(12, MozoTx.instance().mozoDecimal().toInt()))
...
fun BigDecimal?.displayString(scale: Int = 0): String = NumberFormat.getNumberInstance().apply {
    if (scale > 0) {
